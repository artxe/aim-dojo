...
async function on_drop_pubg_file(ev) {
	...
	const fov = 80
	const hipfire = calc_sens_pubg(fov, width, height)
	const ads = hipfire
	const x2 = calc_sens_pubg(fov / 2, width, height)
	const x3 = calc_sens_pubg(fov / 3, width, height)
	const x4 = calc_sens_pubg(fov / 4, width, height)
	const x6 = calc_sens_pubg(fov / 6, width, height)
	const x8 = calc_sens_pubg(fov / 8, width, height)
	const x15 = calc_sens_pubg(fov / 15, width, height)
