...
yx_ratio_btn.addEventListener("click", on_click_yx_ratio)
...
function on_click_yx_ratio() {
	navigator.clipboard.writeText(yx_ratio_btn.textContent)
	send_toast(
		`Copied!\n${yx_ratio_btn.textContent}`,
		1_500
	)
}
/** @returns {void} */
