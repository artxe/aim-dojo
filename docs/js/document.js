...
export const warmup_btn = /** @type {HTMLButtonElement} */(document.getElementById("warmup"))/**/
export const warmup_score_el = /** @type {HTMLSpanElement} */(document.getElementById("warmup_score"))/**/
