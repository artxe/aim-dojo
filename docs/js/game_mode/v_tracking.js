...
v_tracking_score_el.textContent = String(best_score)
/** @returns {void} */
...
function clear_best_score() {
	...
	set_text_if_changed(v_tracking_score_el, 0)
	send_toast(
		"V-Tracking score has been reset!",
		1_500
	)
}
/** @returns {void} */
...
function update_hud() {
	...
	if (score > peak_score) {
		...
		if (score > best_score) {
			...
			set_text_if_changed(v_tracking_score_el, score)
		}
	}
	set_attr_if_changed(
		peak_score_el,
