...
function build_text() {
	...
	off_context.save()
	off_context.fillStyle = text_fill_style
	off_context.font = `${font_px}px ${font}`
	off_context.globalAlpha = text_alpha
...
/** @returns {void} */
function render() {
	const { line_width, stroke_style } = constants.mode.writing
