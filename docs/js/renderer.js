...
export const crosshair_image = (() => {
	...
	off_context.moveTo(32, 0)
	off_context.lineTo(32, 30)
	off_context.moveTo(32, 34)
	off_context.lineTo(32, 64)
	off_context.moveTo(0, 32)
	off_context.lineTo(30, 32)
	off_context.moveTo(34, 32)
	off_context.lineTo(64, 32)
	off_context.stroke()
	off_context.restore()
