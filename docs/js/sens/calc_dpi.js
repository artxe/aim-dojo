...
export function calc_dpi_cs2() {
	...
	return dpi * sens * zoom / calc_sens_cs2(hfov_deg, width, height)
}
/** @returns {number} */
...
export function calc_dpi_fn() {
	...
	const { zoom } = state.dpi_norm
	return dpi * sens * zoom / 100 / calc_sens_fn(80, width, height)
}
/** @returns {number} */
...
export function calc_dpi_ow() {
	...
	return dpi * sens * zoom / 100 / calc_sens_ow(hfov_deg, width, height)
}
/** @returns {number} */
...
export function calc_dpi_val() {
	...
	return dpi * sens * zoom / calc_sens_val(hfov_deg, width, height)
}